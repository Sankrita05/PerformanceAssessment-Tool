...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            numerical_columns = ["writing_score", "reading_score"]
            logging.info("Divide train data into dependent and independend dataframes")
            ...
            logging.info("Divide test data into dependent and independend dataframes")
            input_features_test_df = test_df.drop(columns=[target_columns_name], axis=1)
            target_feature_test_df = test_df[target_columns_name]
            logging.info("Applying Preprocessing on trainig and test dataframes")
